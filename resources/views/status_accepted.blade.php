...
<head>
    ...
    <title>Status Permintaan Diterima - KitaBantu</title>
    <link rel="stylesheet" href="css/status_accepted.css"> 
</head>
<body>
    ...
    <header class="header">
        ...
        <main class="status-main">
            <div class="status-content">
                <img src="./img/checkmark.png" alt="Accepted Icon" class="status-icon">
                <h1 class="status-title">Permintaan Anda Diterima</h1>
                <p class="status-subtitle">Tim kami telah menyetujui permintaan dan telah menghubungi Anda. Mohon periksa email / whatsapp Anda secara berkala.</p>
            </div>
        </main>
