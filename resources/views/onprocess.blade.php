...
<head>
    ...
    <title>Status Permintaan - KitaBantu</title>
    <link rel="stylesheet" href="css/onprocess.css">
</head>
<body>
    ...
    <div class="page-container">
        ...
        <main class="status-main">
            <div class="status-content">
                <img src="./img/jam.png" alt="On Process Icon" class="status-icon">
                <h1 class="status-title">Permintaan Anda Sedang Kami Tinjau</h1>
                <p class="status-subtitle">Mohon menunggu hingga kami mengkonfirmasi permintaan Anda</p>
            </div>
        </main>
